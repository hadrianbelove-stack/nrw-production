---
description: Check a style/UX change across all 7 NRW platforms
---

# Cross-Platform Consistency Check

Review the recent style or UX change and check consistency across ALL 7 platforms.

## Platforms to Check

| # | Platform | Colors File | Detail Screen |
|---|----------|-------------|---------------|
...
2. **Check each platform** - Read the equivalent file on each platform
3. **Report status** for each:
   - ✅ **Consistent** - Already matches
   - ⚠️ **Needs update** - Specify exact change needed
   - ➖ **N/A** - Doesn't apply to this platform (e.g., hover states on mobile)
...
## Updates Needed
[Code changes for each platform that needs updating]
```
