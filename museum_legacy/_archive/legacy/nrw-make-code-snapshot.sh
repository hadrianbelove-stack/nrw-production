...
# FLAT_HANDOFF_ONLY: legacy NRW_SYNC handoffs are deprecated; use WORKING_SET_HANDOFF_*/ files-only

# SNAPSHOT_NOTE: snapshots are code/governance only; not a session handoff artifact
